        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-center items-center gap-4">
                ...
                <form id="deleteImageForm" method="POST" action="/delete_image">
                    ...
                    <input type="hidden" name="image" value="<?php echo e($user->foto); ?>">
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/user/profile/layouts/deleteImageModal.blade.php ENDPATH**/ ?>