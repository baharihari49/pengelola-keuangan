    ...
    <section class="bg-50 h-screen w-screen flex justify-center items-center">
        <div class="px-7 py-7 rounded-md shadow-md flex flex-col items-center justify-center">
            ...
            <div class="w-80">
                ...
                <p class="mb-2 uppercase"><?php echo e($sender_bank); ?></p>
                <div class="bg-gray-200 px-5 py-3 rounded-md">
                    <p class="text-gray-600 font-semibold"><?php echo e($noVa); ?></p>
                </div>
                <p class="my-3">Nominal Transafer</p>
                <div class="bg-gray-200 px-5 py-3 rounded-md">
                    <p class="text-gray-600 font-semibold">Rp <?php echo e(number_format($amount, 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('user.layouts.main_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/user/payments/chosePayment/layouts/virtual_account.blade.php ENDPATH**/ ?>