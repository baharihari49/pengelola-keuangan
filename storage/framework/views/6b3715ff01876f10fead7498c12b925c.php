<section class="bg-gray-50 dark:bg-gray-900 mb-32 lg:mb-28">
    <div class="">
        <!-- Start coding here -->
        <div
            class="bg-white rounded-md overflow-visible dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="flex items-center space-x-3 w-full md:w-auto">
                        ...
                        <div id="actionsDropdown"
                            ...
                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                <?php if(auth()->user()->can('cetak pemasukan')): ?>
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/laporan/pemasukan/layouts/container_laporan_pemasukan.blade.php ENDPATH**/ ?>