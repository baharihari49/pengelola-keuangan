<?php echo $__env->make('dashboard.admin.user.layouts.edit_role', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<section class="bg-gray-50 dark:bg-gray-900 mb-28">
    <?php if(session()->has('password_error')): ?>
        <div id="toast-danger"
            ...
            <div class="ms-3 text-sm font-normal"><?php echo e(session('password_error')); ?></div>
            <button type="button"
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <?php if(auth()->user()->can('tambah user')): ?>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div id="confirm-delete-modal-<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div
                                            ...
                                            <button type="button"
                                                ...
                                                data-modal-hide="confirm-delete-modal-<?php echo e($item->id); ?>">
                                        ...
                                        <div class="p-4 md:p-5">
                                            <form class="space-y-4" action="/delete_user" method="POST">
                                                ...
                                                <input name="email" type="hidden" value="<?php echo e($item->email); ?>">
                                                <div class="mb-4">
                                                    <label for="password"
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row"
                                    ...
                                    <div class="flex gap-2 items-center">
                                        <img class="w-10 h-10 rounded-full"
                                            src="<?php echo e($item->foto ?? 'https://res.cloudinary.com/du0tz73ma/image/upload/v1700278579/default-profile_y2huqf.jpg'); ?>"
                                            alt="Rounded avatar">
                                ...
                                <td class="px-4 py-3 capitalize">
                                    <?php if($roles = $item->getRoleNames()): ?>
                                        <?php echo e($roles[0] ?? 'user'); ?>

                                    <?php else: ?>
                                        No Role
                                    <?php endif; ?>
                                </td>
                                <td class="px-4 py-3"><?php echo e($item->payment->status ?? 'Free'); ?></td>
                                <td class="px-4 py-3"><?php echo e($item->created_at); ?></td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="" data-dropdown-toggle="user-id<?php echo e($item->id); ?>"
                                    ...
                                    <div id="user-id<?php echo e($item->id); ?>"
                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="">
                                            <?php if(auth()->user()->can('ubah user')): ?>
                                                <li>
                                                    <button data-modal-target="edit-role-modal-<?php echo e($item->id); ?>"
                                                        data-modal-toggle="edit-role-modal-<?php echo e($item->id); ?>" class="w-full text-left py-2 px-4 hover:bg-gray-100">Edit Role</button>
                                                </li>
                                            <?php else: ?>
                                                <li>
                                                    <button disabled data-modal-target="edit-role-modal-<?php echo e($item->id); ?>"
                                                        data-modal-toggle="edit-role-modal-<?php echo e($item->id); ?>" class="w-full text-left py-2 px-4 hover:bg-gray-100">Edit Role</button>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                        <div class="py-1">
                                            <?php if(auth()->user()->can('hapus user')): ?>
                                            <button data-modal-target="confirm-delete-modal-<?php echo e($item->id); ?>"
                                                data-modal-toggle="confirm-delete-modal-<?php echo e($item->id); ?>"
                                                ...
                                                <?php echo e($item->username); ?></button>
                                            <?php else: ?>
                                            <button disabled data-modal-target="confirm-delete-modal-<?php echo e($item->id); ?>"
                                                data-modal-toggle="confirm-delete-modal-<?php echo e($item->id); ?>"
                                                class="block w-full text-left py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete
                                                <?php echo e($item->username); ?></button>
                                            <?php endif; ?>
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/admin/user/layouts/tabel_user.blade.php ENDPATH**/ ?>