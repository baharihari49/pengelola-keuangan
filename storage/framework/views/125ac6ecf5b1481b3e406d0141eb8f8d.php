<section class="bg-white rounded-md shadow-md p-5 mb-32">
    <div>
        <p class="text-xl font-semibold">Role : <?php echo e($data->name); ?></p>
    </div>
    <hr class="mt-4 mb-6">
                    ...
                    <tr>
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('lihat transaksi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="tambah transaksi" id=""
                                <?php echo e(in_array('tambah transaksi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="ubah transaksi" id=""
                                <?php echo e(in_array('ubah transaksi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="hapus transaksi" id=""
                                <?php echo e(in_array('hapus transaksi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="cetak transaksi" id=""
                                <?php echo e(in_array('cetak transaksi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tr>
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('lihat kategori transaksi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" value="tambah kategori transaksi" name="permission[]" id=""
                                <?php echo e(in_array('tambah kategori transaksi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" value="ubah kategori transaksi" name="permission[]" id=""
                                <?php echo e(in_array('ubah kategori transaksi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" value="hapus kategori transaksi" name="permission[]" id=""
                                <?php echo e(in_array('hapus kategori transaksi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                    ...
                    <tr>
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('lihat anggaran', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" value="tambah anggaran" name="permission[]" id=""
                                <?php echo e(in_array('tambah anggaran', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" value="ubah anggaran" name="permission[]" id=""
                                <?php echo e(in_array('ubah anggaran', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" value="hapus anggaran" name="permission[]" id=""
                                <?php echo e(in_array('hapus anggaran', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                    ...
                    <tr>
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('lihat supplier', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" value="tambah supplier" name="permission[]" id=""
                                <?php echo e(in_array('tambah supplier', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" value="ubah supplier" name="permission[]" id=""
                                <?php echo e(in_array('ubah supplier', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" value="hapus supplier" name="permission[]" id=""
                                <?php echo e(in_array('hapus supplier', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                    ...
                    <tr>
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('lihat pemasukan', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('cetak pemasukan', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('lihat pengeluaran', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('cetak pengeluaran', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('lihat labarugi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('cetak labarugi', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tr>
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('lihat user', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="tambah user" id=""
                                <?php echo e(in_array('tambah user', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="ubah user" id=""
                                <?php echo e(in_array('ubah user', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="hapus user" id=""
                                <?php echo e(in_array('hapus user', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                    ...
                    <tr>
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('lihat feedback', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('ubah feedback', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="hapus feedback" id=""
                                <?php echo e(in_array('hapus feedback', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                    ...
                    <tr>
                        ...
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                ...
                                <?php echo e(in_array('lihat akses level', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="tambah akses level" id=""
                                <?php echo e(in_array('tambah akses level', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="ubah akses level" id=""
                                <?php echo e(in_array('ubah akses level', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
                            <input
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                type="checkbox" name="permission[]" value="hapus akses level" id=""
                                <?php echo e(in_array('hapus akses level', $rolePermissions) ? 'checked' : ''); ?>>
                        </td>
                        <td align="center" scope="col" class="px-4 py-3">
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/admin/aksesLevel/layouts/editAksesLevel/layouts/tabel.blade.php ENDPATH**/ ?>