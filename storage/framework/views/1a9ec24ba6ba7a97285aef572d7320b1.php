<?php echo $__env->make('dashboard.transaksi.layouts.create_transaksi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('dashboard.transaksi.layouts.update_transaksi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<section class="">
    ...
    <?php if(session()->has('sucsess') || session()->has('succes_update')): ?>
        <div id="modalError" tabindex="-1"
            class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-full flex"
            aria-modal="true" role="dialog">
            <div class="relative p-4 w-full max-w-md h-auto">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <p class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Transaksi anda berhasil
                        <?php echo e(session()->has('sucsess') ? 'dibuat' : 'diubah'); ?></p>
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <?php if(auth()->user()->can('tambah transaksi')): ?>
                ...
                <div id="actionsDropdown"
                    ...
                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                        ...
                        <?php if(auth()->user()->can('cetak transaksi')): ?>
                        ...
                        <?php $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="tabel-row" class="border-b dark:border-gray-700">
                                <div id="container-tabel-date">
                                    ...
                                    <td id="tabel-date" class="px-4 py-3"><?php echo e($t->no_transaksi ?? '--'); ?></td>
                                    ...
                                    <td id="tabel-kategori" class="px-4 py-3 hidden"><?php echo e($t->kategori_transaksi->nama ?? '--'); ?>

                                    </td>
                                    <td id="tabel-suppllier" class="px-4 py-3 hidden">
                                        <?php echo e($t->suppliers_or_customers->nama_bisnis ?? '--'); ?></td>
                                    <td id="tabel-deskripsi" class="px-4 py-3 max-w-sm hidden"><?php echo e($t->deskripsi ?? '--'); ?></td>
                                    <td id="tabel-date" class="px-4 py-3 text-right">Rp
                                        <?php echo e(number_format($t->jumlah, 0, ',', '.')); ?></td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <div class="flex gap-5 mr-5">
                                            <?php if(auth()->user()->can('ubah transaksi')): ?>
                                            <button class="p-3 border bg-red-600 text-white rounded-xl"
                                                style="border-radius: 50%;" data-uuid="<?php echo e($t->uuid); ?>"
                                            ...
                                            <?php endif; ?>
                                            <a href="/detail_transaksi/?uuid=<?php echo e($t->uuid); ?>" class="p-3 border bg-blue-600 text-white rounded-xl"
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/transaksi/layouts/tabel_transaksi.blade.php ENDPATH**/ ?>