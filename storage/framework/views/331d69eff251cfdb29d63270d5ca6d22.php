    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <div class="flex ms-1 lg:ms-8">
                <figure class="flex items-end gap-2">
                    <?php if(file_exists(public_path('./image/logo/octans_logo.png'))): ?>
                        <img class="h-10 md:h-12" src="<?php echo e(asset('./image/logo/octans_logo.png')); ?>" alt="">
                    <?php else: ?>
                        <img class="h-10 md:h-12" src="<?php echo e(asset('./image/logo/octans_logo.png')); ?>" alt="">
                    <?php endif; ?>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                ...
                <div class="py-3 px-4">
                    <span
                        class="block text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(auth()->user()->nama); ?></span>
                    <span
                ...
                <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    ...
                    <li>
                        <form method="POST" action="/logout">
                            <?php echo csrf_field(); ?>
                            <button class="flex items-center gap-2 ml-4" type="submit"
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/layouts/nav.blade.php ENDPATH**/ ?>