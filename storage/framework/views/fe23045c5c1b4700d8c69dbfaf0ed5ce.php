                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select name="kategori_anggaran_id" id="kategori_anggaran"
                            ...
                            <?php $__currentLoopData = $kategoriAnggarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($kt->id); ?>"><?php echo e($kt->nama); ?></option>
                    ...
                    <div>
                        <label for="kategori_transaksi"
                            ...
                            Anggaran</label>
                        <select name="kategori_transaksi_id" id="kategori-anggaran"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <option selected="">Select category</option>
                        </select>
                    </div>
...
</script><?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/anggaran/layouts/create_anggaran.blade.php ENDPATH**/ ?>