    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form method="POST" action="/supplier_or_customer_update">
                ...
                <div class="space-x-1">
                    <?php if(auth()->user()->can('ubah supplier')): ?>
                    ...
                    <?php endif; ?>
                        ...
                        <?php if(auth()->user()->can('hapus supplier')): ?>
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/supplier/layouts/update_modal.blade.php ENDPATH**/ ?>