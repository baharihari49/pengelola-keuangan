        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3 text-right">Rp <?php echo e(number_format($pemasukan, 0, ',', '.')); ?></td>
                </tr>
                ...
                <tr class="border-b dark:border-gray-700">
                    <th scope="row"
                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white pl-10 text-left">- <?php echo e($item->nama); ?></th>
                    <td class="px-4 py-3 text-right">Rp <?php echo e(number_format($item->jumlah, 0, ',', '.')); ?></td>
                </tr>
                ...
                <tr style="background: #F3F4F6" class="border-b bg-gray-100 dark:border-gray-700">
                    ...
                    <td class="px-4 py-3 text-gray-800 font-semibold text-right">Rp <?php echo e(number_format($pemasukan, 0, ',', '.')); ?></td>
                </tr>

                <tr class="border-b dark:border-gray-700">
                    <th scope="row"
                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white text-left">* Pengeluaran</th>
                    <td class="px-4 py-3 text-right">Rp <?php echo e(number_format($pengeluaran, 0, ',', '.')); ?></td>
                </tr>
                ...
                <tr style="background: #F3F4F6" class="border-b bg-gray-100 dark:border-gray-700">
                    ...
                    <td class="px-4 py-3 text-gray-800 font-semibold text-right">Rp <?php echo e(number_format($pengeluaran, 0, ',', '.')); ?></td>
                </tr>
            </tbody>
        </table>
    </section>
...
</html><?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/laporan/labarugi/layouts/print/index.blade.php ENDPATH**/ ?>