        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="/anggaran" method="POST">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <?php if(auth()->user()->can('hapus anggaran')): ?>
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/anggaran/layouts/update_anggaran.blade.php ENDPATH**/ ?>