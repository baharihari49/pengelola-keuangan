                ...
                <form class="space-y-4 md:space-y-6" method="POST" action="/register">
                    ...
                    <div>
                        ...
                        <?php if($errors->has('username')): ?>
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Sorry,</span> <?php echo e($errors->first('username')); ?></p>
                        <?php endif; ?>
                    ...
                    <div>
                        ...
                        <?php if($errors->has('email')): ?>
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Sorry,</span> <?php echo e($errors->first('email')); ?></p>
                        <?php endif; ?>
                    </div>
                    <div>
...
<?php echo $__env->make('user.layouts.main_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/user/register/index.blade.php ENDPATH**/ ?>