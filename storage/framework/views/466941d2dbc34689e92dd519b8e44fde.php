...
<div class="flex justify-between p-3 md:p-6 pb-0 md:pb-0">
    <div>
        ...
        <h5 class="leading-none text-xl lg:text-3xl font-bold text-gray-900 dark:text-white pb-2">Rp
            <?php echo e(number_format($pendapatan_bulan_ini, 0, ',', '.')); ?>

        </h5>
    </div>
    <div class="flex items-center px-2.5 py-0.5 text-base font-semibold text-green-500 dark:text-green-500 text-center">
        <?php if($persentasePerbandingan['persentaseSelisihPendapatBulanBerjalan'] > 0): ?>
            <div class="flex items-center xl:gap-1">
                <p class="text-green-500 text-xs xl:text-base font-semibold">
                    <?php echo e($persentasePerbandingan['persentaseSelisihPendapatBulanBerjalan']); ?>%</p>
        ...
        <?php elseif($persentasePerbandingan['persentaseSelisihPendapatBulanBerjalan'] < 0): ?>
            <div class="flex items-center xl:gap-1">
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/charts/line_chart.blade.php ENDPATH**/ ?>