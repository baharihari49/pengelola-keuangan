            ...
            <form method="POST" action="/supplier_or_customer">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select id="category" name="jenis_transaksi_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <option value="<?php echo e($item->id); ?>"><?php echo e(($item->id === 1) ? 'Costumer' : 'Supplier'); ?></option>
...
</div><?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/supplier/layouts/create_modal.blade.php ENDPATH**/ ?>