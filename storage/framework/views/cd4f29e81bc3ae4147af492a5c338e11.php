...
<section class="bg-white rounded-xl shadow-md p-5 mb-32">
        ...
        <div class="col-span-1">
            <table class="w-full">
                <tr class="">
                    ...
                    <td> : <?php echo e($data[0]->no_transaksi); ?></td>
                </tr>
                <tr>
                    <td class="py-3">Tanggal</td>
                    <td> : <?php echo e($data[0]->tanggal); ?></td>
                </tr>
                <tr>
                    <td class="py-3">Deskripsi</td>
                    <td> : <?php echo e($data[0]->deskripsi ?? '--'); ?></td>
                </tr>
                <tr>
                    <td class="py-3">Jenis Transaksi</td>
                    <td> : <?php echo e($data[0]->jenis_transaksi->nama); ?></td>
                </tr>
            </table>
        </div>
        <div class="col-span-1">
            <table class="w-full">
                <tr class="">
                    ...
                    <td> : <?php echo e($data[0]->kategori_transaksi->nama); ?></td>
                </tr>
                <tr class="">
                    <td class="py-3"><?php echo e(($data[0]->jenis_transaksi_id == 1) ? 'Customer' : 'Supplier'); ?></td>
                    <td> : <?php echo e($data[0]->suppliers_or_customers->nama_bisnis ?? '--'); ?></td>
                </tr>
                <tr class="">
                    <td class="py-3">Dibuat oleh</td>
                    <td> : <?php echo e((auth()->user()->nama != null) ? auth()->user()->nama : auth()->user()->username); ?></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <table class="w-full">
        ...
        <tr class="">
            <td class="text-lift px-4 py-3 text-gray-700"><?php echo e($data[0]->kategori_transaksi->nama); ?></td>
            <td class="text-right pl-4 pr-7 py-3 font-bold text-base text-gray-700">
                <?php echo e(number_format($data[0]->jumlah, 0, ',', '.')); ?></td>
        </tr>
    ...
    <nav>
        <div class="flex items-center gap-3">
            <button class="py-3 px-8 border rounded-md bg-red-600 text-white" data-uuid="<?php echo e($data[0]->uuid); ?>" id="updateProductButtonDetail"
            ...
            <a href="/pdf_detail_transaksi/?uuid=<?php echo e($data[0]->uuid); ?>" class="bg-blue-700 py-2 px-6 text-white rounded-md font-medium">Print</a>
        </div>
    </nav>
</section>
<script>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/transaksi/layouts/detail_transaksi.blade.php ENDPATH**/ ?>