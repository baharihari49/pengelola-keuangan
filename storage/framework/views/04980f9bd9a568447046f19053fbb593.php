        ...
        <ul class="space-y-2">
            <li>
                <a id="icon-sidebar" href="/"
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('/') ? 'bg-gray-100' : ''); ?>">
            ...
            <li>
                <a id="icon-sidebar" href="/transaksi"
                    class="flex items-center p-2 text-base font-medium <?php echo e(request()->is('transaksi') ? 'bg-gray-100' : ''); ?> text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
            ...
            <li>
                <a id="icon-sidebar" href="/kategori_transaksi"
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('kategori_transaksi') ? 'bg-gray-100' : ''); ?>">
                    <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
            ...
            <li>
                <a id="icon-sidebar" href="/anggaran"
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('anggaran') ? 'bg-gray-100' : ''); ?>">
                    <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
            ...
            <li>
                <a id="icon-sidebar" href="/supplier_costumer"
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('supplier_costumer') ? 'bg-gray-100' : ''); ?>">
                    <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
            ...
            <li>
                <button id="icon-sidebar" type="button"
                    class="flex items-center w-full p-2 text-base <?php echo e(request()->path() == 'pemasukan' || request()->path() == 'pengeluaran' || request()->path() == 'laba_rugi' ? 'bg-gray-100' : ''); ?> font-medium text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                ...
                <ul id="dropdown-pages"
                    class="<?php echo e(request()->path() == 'pemasukan' || request()->path() == 'pengeluaran' || request()->path() == 'laba_rugi' ? '' : 'hidden'); ?>

                  py-2 space-y-2">
                    <li>
                        <a href="/pemasukan"
                            class="flex items-center p-2 text-base <?php echo e(request()->path() == 'pemasukan' ? 'bg-gray-100' : ''); ?> text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Pemasukan</a>
                    </li>
                    <li>
                        <a href="/pengeluaran"
                            class="flex items-center p-2 text-base text-gray-900 <?php echo e(request()->path() == 'pengeluaran' ? 'bg-gray-100' : ''); ?> transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Pengeluaran</a>
                    </li>
                    <li>
                        <a href="/laba_rugi/?id=all"
                            class="flex items-center p-2 <?php echo e(request()->path() == 'laba_rugi' ? 'bg-gary-100' : ''); ?> text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Laba
                            Rugi</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a id="icon-sidebar" href="/feedback"
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('feedback') ? 'bg-gray-100' : ''); ?>">
                    <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
            ...
            <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'super admin')): ?>
                ...
                <ul>
                    <?php if(auth()->user()->can('lihat user')): ?>
                        <li>
                            <a id="icon-sidebar" href="/user"
                                class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('user') ? 'bg-gray-100' : ''); ?>">
                                <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    ...
                    <?php if(auth()->user()->can('lihat feedback')): ?>
                        <li>
                            <a id="icon-sidebar" href="/feedback_manage"
                                class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('feedback_manage') ? 'bg-gray-100' : ''); ?>">
                                <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2"
                    ...
                    <li>
                        <a id="icon-sidebar" href="/manage-kategori"
                            class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('manage-kategori') ? 'bg-gray-100' : ''); ?>">
                            <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
                    ...
                    <?php if(auth()->user()->can('lihat akses level')): ?>
                        <li>
                            <a id="icon-sidebar" href="/akses_level"
                                class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('akses_level') ? 'bg-gray-100' : ''); ?>">
                                <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
                    ...
                    <li>
                        <a id="icon-sidebar" href="payment-manage"
                            class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('payment-manage') ? 'bg-gray-100' : ''); ?>">
                            <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
                    ...
                    <li>
                        <a id="icon-sidebar" href="/log-viewer" target="_blank"
                            class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo e(request()->is('log-viewer') ? 'bg-gray-100' : ''); ?>">
                            <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>