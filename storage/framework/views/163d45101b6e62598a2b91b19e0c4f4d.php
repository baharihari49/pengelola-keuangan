    ...
    <div class="relative p-4 w-full max-w-2xl h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex flex-col items-center">
                <div class="w-fit">
                    <?php echo $__env->make('dashboard.anggaran.layouts.charts.donut_chart_budgeting_kebutuhan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
...
<?php /**PATH /home/bahari/Desktop/octans/pengelola-keuangan/resources/views/dashboard/anggaran/layouts/create_budget.blade.php ENDPATH**/ ?>