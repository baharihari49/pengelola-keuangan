        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen md:h-screen lg:py-0">
            ...
            <div
                ...
                <div class="p-6 space-y-2 md:space-y-4 sm:px-8 sm:py-8 sm:pb-5">
                    <h1
                        class="text-x text-center font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                        Konfirmasi Email Anda
                    </h1>
                    <p class="text-sm text-gray-500 text-center">Silahkan buka email anda dan klik konfirmasi untuk
                        melanjutkan pendaftaran</p>
                </div>
                <form class="text-center pb-2" action="/email/verification-notification" method="POST">
                    @csrf
                    <input type="hidden">
                    <span class="text-sm text-gray-500">Belum menerima email? <button class="text-sm text-blue-500">Kirim
                            ulang</button></span>
                </form>
            </div>
        </div>
