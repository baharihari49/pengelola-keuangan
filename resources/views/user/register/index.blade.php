                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="/register">
                        ...
                        <div>
                            ...
                            @if ($errors->has('username'))
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span
                                        class="font-medium">Sorry,</span> {{ $errors->first('username') }}</p>
                            @endif
                        ...
                        <div>
                            ...
                            @if ($errors->has('email'))
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span
                                        class="font-medium">Sorry,</span> {{ $errors->first('email') }}</p>
                            @endif
                        </div>
                        <div>
                        ...
                        <button type="submit"
                            class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Masuk
                            dan daftar</button>
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Sudah daftar ? <a href="/login"
