    ...
    <div class="bg-white rounded-xl p-5 h-full">
        <form method="post" action="/user" class="grid grid-cols-5 gap-5" enctype="multipart/form-data">
            ...
            <figure class="col-span-1">
                <img class="rounded" src="./image/profile_picture/bahari.png" alt="foto user">
                <label class="block mt-3 mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Ubah Gambar</label>
                <input name="profile-image" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file">
