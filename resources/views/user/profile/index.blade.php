                    ...
                    <div>
                        ...
                        <div class="flex w-full gap-3 mt-3">
                            <button type="button" data-modal-target="default-modal" data-modal-toggle="default-modal"
                                class="bg-blue-600 py-2 px-4 text-white rounded-md">{{ isset($user->foto) ? 'Ubah' : 'Upload' }}
                                foto</button>
            ...
            <div class="grid md:grid-cols-2 md:gap-6 items-end">
                <div class="mb-5 lg:mb-0">
                    <img id="avatar" class="w-20 h-20 rounded mb-2"
                        src="{{ isset($info_bisnis[0]->logo) ? $info_bisnis[0]->logo : 'https://res.cloudinary.com/du0tz73ma/image/upload/v1700279273/building_z7thy7.png' }}"
                        alt="Logo">
                    <button data-modal-toggle="deleteLogoModal"
                        class="py-1 {{ isset($info_bisnis[0]->logo) ? '' : 'hidden ' }} px-2 text-white font-medium mb-3 bg-red-700 text-xs rounded-md">hapus
                        logo</button>
