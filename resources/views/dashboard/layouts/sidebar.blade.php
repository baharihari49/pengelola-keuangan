        ...
        <ul class="space-y-2">
            ...
            <li>
                ...
                <ul id="dropdown-pages" class="{{ (request()->path() == 'pemasukan' || request()->path() == 'pengeluaran') ? '' : 'hidden' }}
                  ...
                  <li>
                    <a href="/pengeluaran" class="flex items-center p-2 text-base text-gray-900 {{(request()->path() == 'pengeluaran') ? 'bg-gray-100' : ''}} transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Pengeluaran</a>
                  </li>
                  <li>
