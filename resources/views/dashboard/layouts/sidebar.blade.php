<aside id="default-sidebar"
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="mt-3 py-3 border-t-2 space-y-2">
            <li clas pt-2>
                <a id="icon-sidebar" href="/panduan"
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{(request()->is('panduan') ? 'bg-gray-100' : '')}}">
                    ...
                    <span id="text-sidebar" class="ml-3">Panduan Pengguna</span>
                </a>
            </li>
        </ul>
    </div>
