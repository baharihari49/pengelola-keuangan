<aside id="default-sidebar"
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        <h5 id="text-sidebar" style="margin: 1.5rem 0 1rem 0;"><b>Main</b></h5>
        <ul class="space-y-2">
            <li>
            ...
            <li>
                ...
                <ul id="dropdown-pages"
                  ...
                  py-2 space-y-2">
                    <li>
                        <a id="text-sidebar" href="/pemasukan"
                    ...
                    <li>
                        <a id="text-sidebar" href="/pengeluaran"
                    ...
                    <li>
                        <a id="text-sidebar" href="/laba_rugi/?id=all"
            ...
            @role('super admin')
                <hr class="my-5">
                <h5 id="text-sidebar" style="margin-top: 1.3rem;"><b>Management</b></h5>
                <ul>
                    ...
                    <hr class="my-5">
                    <h5 id="text-sidebar" style="margin-top: 1.3rem;"><b>Back System Monitor</b></h5>
                    <ul>
                        <li>
                        ...
                        <li>
                            <a id="icon-sidebar" href="/pulse" target="_blank"
                                class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ request()->is('pulse') ? 'bg-gray-100' : '' }}">
                                <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
                                ...
                                <span id="text-sidebar" class="ml-3">Pulse</span>
                            </a>
                        </li>
                        <li>
                            <a id="icon-sidebar" href="/telescope" target="_blank"
                                class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ request()->is('telescope') ? 'bg-gray-100' : '' }}">
                                <svg class="w-5 h-5 text-gray-600 dark:text-white" aria-hidden="true"
                                ...
                                <span id="text-sidebar" class="ml-3">Telescope</span>
                            </a>
                        </li>
                    </ul>
