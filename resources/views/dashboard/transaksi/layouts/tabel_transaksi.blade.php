...
<section class="">
    ...
    <div id="modalError" tabindex="-1" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-full flex" aria-modal="true" role="dialog">
    ...
    <div class="mx-auto w-full">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 overflow-x-auto md:overflow-hidden">
                    ...
                    <tbody>
                        ...
                        <tr id="tabel-row" class="border-b dark:border-gray-700">
                           <div id="container-tabel-date">
                                ...
                                <td id="tabel-date" class="px-4 py-3">{{$t->suppliers_or_customers->nama_bisnis}}</td>
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                <div class="flex gap-5 mr-5">
                                   <button class="py-1 px-3 border bg-red-600 text-white rounded-xl" data-uuid="{{$t->uuid}}" id="updateProductButton">
                                    void
                                   </button>
                                </div>
                            </td>
