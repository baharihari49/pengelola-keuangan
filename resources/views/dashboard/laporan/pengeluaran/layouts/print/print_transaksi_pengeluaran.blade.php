...
<body>
    <div>
        <h1 class="text-2xl text-center font-semibold mb-5">Laporan Pengeluaran {{($bulan != null) ? 'Bulan ' .$bulan : ''}}</h1>
    </div>
    <section>
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody id="tabelBody">
                ...
                <tr style="background: #F3F4F6" class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3 font-semibold border">Rp {{number_format($pengeluaran, 0, ',', '.')}}</td>
                </tr>
            </tbody>
        </table>
    </section>
