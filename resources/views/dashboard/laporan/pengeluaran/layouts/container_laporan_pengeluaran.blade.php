            ...
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="flex items-center space-x-3 w-full md:w-auto">
                    ...
                    <div id="actionsDropdown"
                        ...
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="actionsDropdownButton">
                            <li onclick="acttionFilter(this)" id="filterKategori" data-id="all" data-id-2="2">
                                <a
                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Semua</a>
                            </li>
                            @foreach ($kategori as $item)
                            <li onclick="acttionFilter(this)" id="filterKategori" data-id="{{$item->id}}" data-id-2="2">
                                <a
                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{$item->nama}}</a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
                ...
                <div id="periodeDropdown"
                    ...
                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="actionsDropdownButton">
                        ...
                        <li onclick="acttionPeriode(this)" id="filterKategori" data-id="{{$item->id_bulan}}" data-id-2="2">
                            <a
                    ...
                    {{-- <div id="filterDropdown" class="z-10 hidden w-48 p-3 bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                            ...
                            <li class="flex items-center">
                                ...
                                <label for="apple" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">{{$item->nama}}</label>
                            </li>
                            @endforeach
                        </ul>
                    </div> --}}
