            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row"
                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white pl-10">- {{$item->nama}}</th>
                            <td class="px-4 py-3 text-base text-right">Rp {{number_format($item->jumlah, 0, ',', '.')}}</td>
                        </tr>
                        @endforeach
                        <tr class="border-b bg-gray-100 dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 text-base text-gray-800 font-semibold text-right">Rp {{number_format($pemasukan, 0, ',', '.')}}</td>
                        </tr>
                        ...
                        <tr class="border-b bg-gray-100 dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 text-base text-gray-800 font-semibold text-right">Rp {{number_format($pengeluaran, 0, ',', '.')}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
