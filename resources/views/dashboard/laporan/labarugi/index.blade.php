...
@section('container')
    <div class="flex items-center justify-between">
        <h3 class="text-3xl font-bold text-gray-800 my-5">Laporan Laba Rugi {{($bulan != null) ? 'Periode ' .$bulan : 'Semua Periode'}}</h3>
            ...
            <div id="actionsDropdown"
                ...
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                    ...
                    <li onclick="" id="filterKategori" data-id-2="1" data-id="all">
                        <a id="linkPrint" href="/pdf_laba_rugi/?id={{request()->id}}"
                            class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Print</a>
                    </li>
                    <li onclick="" id="filterKategori" data-id-2="1" data-id="all">
                        <a id="linkExcel" href="/laba_rugi_xlsx/?id={{request()->id}}"
