...
<!-- Main modal -->
<div id="createBudget" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white w-max rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex flex-col items-center">
                ...
                <form id="fromBudget" method="POST" class="w-fit">
                    <p class="text-xs text-gray-800 mb-1 mt-2">Keungan yang sehat umumnya 50% digunakan untuk kebutuhan</p>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a id="btnDeleteBudget"  href="/budgeting_delete"
