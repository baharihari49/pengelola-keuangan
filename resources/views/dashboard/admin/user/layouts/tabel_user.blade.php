                                    ...
                                    <li>
                                        @if($item->hasRole('admin'))
                                            ...
                                            <a href="/remove_role/?id={{$item->id}}"
                                                class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Hapus Super admin</a>
                                        @else
                                            <!-- Jika pengguna bukan admin, tampilkan tautan "Jadikan Super Admin" -->
                                            <a href="/give_role/?id={{$item->id}}"
                                                class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Jadikan Super admin</a>
                                        @endif
                                    </li>
