...
<div class="grid grid-cols-1 grid-cols-2 lg:grid-cols-4 gap-2 xl:gap-4 mb-4">
    ...
    <div class="bg-white shadow-md border-gray-300 rounded-lg dark:border-gray-600 flex items-center p-3 xl:p-5">
        <div class="w-full">
            ...
            <p class="mt-3 mb-1 text-md xl:text-2xl 2xl:text-3xl font-bold">Rp {{number_format($jumlahAnggaran, 0, ',', '.')}}</p>
            <p class="text-gray-500 text-xs xl:text-sm font-bold">Anggaran</p>
        </div>
    </div>
    <div class="bg-white shadow-md border-gray-300 rounded-lg dark:border-gray-600 flex items-center p-3 xl:p-5">
        <div class="w-full">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
    ...
    <div class="bg-white shadow-md relative p-0 rounded-lg lg:col-span-1 border-gray-300 dark:border-gray-600 h-72 xl:h">
        <div class="py-2">
