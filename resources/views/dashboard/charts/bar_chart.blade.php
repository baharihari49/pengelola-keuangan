...
{{-- <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6"> --}}
    <div class="flex justify-between border-gray-200 border-b dark:border-gray-700 pb-3">
      <dl>
        <dt class="text-base font-normal text-gray-500 dark:text-gray-400 pb-1">Hemat</dt>
        <dd class="leading-none text-3xl font-semibold text-gray-900 dark:text-white">Rp 500.000</dd>
      </dl>
      <div>
    ...
    <div class="grid grid-cols-2 py-3">
      <dl>
        <dt class="text-base font-normal text-gray-500 dark:text-gray-400 pb-1">Pendapatan</dt>
        <dd class="leading-none text-xl font-bold text-green-500 dark:text-green-400">Rp</dd>
      </dl>
      <dl>
        <dt class="text-base font-normal text-gray-500 dark:text-gray-400 pb-1">Pengeluaran</dt>
        <dd class="leading-none text-xl font-bold text-red-600 dark:text-red-500">Rp</dd>
      </dl>
    </div>
